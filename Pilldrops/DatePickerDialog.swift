...
public class DatePickerDialog: UIView {
    ...
    public func show(title: String, doneButtonTitle: String = "Schedule", cancelButtonTitle: String = "Exit", defaultDate: NSDate = NSDate(), datePickerMode: UIDatePickerMode = .DateAndTime, callback: DatePickerCallback) {
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.setTitleColor(UIColor(red:0.20, green:0.57, blue:0.89, alpha:1), forState: UIControlState.Highlighted)
